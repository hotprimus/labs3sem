...
struct qt_meta_stringdata_CLASSUIENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSUIENDCLASS = QtMocHelpers::stringData(
    "UI",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSUIENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject UI::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSUIENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSUIENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSUIENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *UI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSUIENDCLASS.stringdata0))
